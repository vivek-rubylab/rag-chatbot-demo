...
Built as the companion repo for the Medium article **[The LLM Is the Lead Singer. Don't Let It Run the Soundboard.](https://medium.com/@theSystemsMind/the-llm-is-the-lead-singer-dont-let-it-run-the-soundboard-f3a226fcd26c)**
...
```bash
git clone https://github.com/vivek-rubylab/rag-chatbot-demo.git
cd rag-chatbot-demo
