...
ActiveRecord::Schema[8.1].define(version: 2025_01_01_000006) do
  ...
  create_table "solid_cable_messages", force: :cascade do |t|
    ...
    t.index ["channel", "id"], name: "index_solid_cable_messages_on_channel"
  ...
  create_table "solid_queue_processes", force: :cascade do |t|
    ...
    t.index ["supervisor_id", "id"], name: "index_solid_queue_processes_on_supervisor_id"
  end
  ...
  create_table "solid_queue_scheduled_executions", force: :cascade do |t|
    ...
    t.index ["scheduled_at", "priority", "job_id"], name: "index_solid_queue_dispatch_order"
  end
  ...
  create_table "solid_queue_semaphores", force: :cascade do |t|
    ...
    t.index ["expires_at", "value"], name: "index_solid_queue_semaphores_on_expires_at_and_value"
